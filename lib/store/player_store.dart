...
abstract class _PlayerStore implements Store {
  ...
  @action
  Future setPlayerFromDB(String statKeeperFireID, String fireID) async {
    player = await RepositoryServicePlayers.getPlayer(statKeeperFireID, fireID);
  }

  @action
  Future<Player> getPlayerFromDB(String statKeeperFireID, String fireID) async {
    return player =
        await RepositoryServicePlayers.getPlayer(statKeeperFireID, fireID);
  }
